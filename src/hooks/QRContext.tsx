...
import { defaultQRConfig } from '@/constants';
...
interface QRContextType {
    ...
    handleNestedChange: <T extends keyof QRConfig, K extends keyof NonNullable<QRConfig[T]>>(
        parentKey: T,
        key: K,
...
export const QRProvider = ({ children }: { children: React.ReactNode }) => {
    ...
    const handleNestedChange = useCallback(
        <T extends keyof QRConfig, K extends keyof NonNullable<QRConfig[T]>>(
            parentKey: T,
            key: K,
            value: NonNullable<QRConfig[T]>[K],
        ) => {
