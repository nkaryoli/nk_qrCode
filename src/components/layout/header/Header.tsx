...
const Header = () => {
    ...
    return (
		<header className="fixed top-0 left-0 right-0 flex justify-between items-center w-screen py-3 px-6 md:px-11 backdrop-blur-sm bg-white/10 dark:bg-black/10 z-50">
            <NavLink
                to="/"
